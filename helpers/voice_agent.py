...
async def main() -> None:
    ...
    print("Banking assistant (VOICE). Say 'end' to finish.\n")
    ...
    while True:
        ...
        try:
            ...
            print(
                "[ERROR] No default input audio device available in this environment.\n"
                f"Details: {e}\n"
                "This is typical in WSL – there is no access to the microphone.\n"
                "Run this client on a system with a microphone (e.g. native Linux/Windows) "
                "or use a file-based / web version."
            )
            return
        ...
        if text.lower() in ["end", "exit", "stop", "quit"]:
        ...
        if tts_engine is not None:
            ...
            print("[INFO] TTS disabled (no engine).")
